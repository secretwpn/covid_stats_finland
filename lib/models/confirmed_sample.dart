...
class ConfirmedSample {
  ...
  factory ConfirmedSample.fromJson(Map<String, dynamic> json) =>
      ConfirmedSample(
  ...
  factory ConfirmedSample.fromRawJson(String str) =>
      ConfirmedSample.fromJson(json.decode(str));

  static int getConfirmedToDate(
          DateTime dateTime, List<ConfirmedSample> samples) =>
      samples
